  ...
  return (
    <>
      <div className="bg-brand-color">
        <div className="container mx-auto xl:px-28 2xl:px-32 h-16 md:h-10 flex items-center justify-center  md:justify-between ">
          ...
          <nav className="hidden md:flex gap-8 text-sm font-semibold ">
            <a href='#' className="flex gap-x-2 text-white transition-all hover:text-opacity-70 opacity-90">
              <BsGlobe size={18} />
              Türkçe (TR)
      ...
      <div className='container mx-auto  h-10 flex md:hidden items-center px-2 justify-between'>
        <div className=' flex items-center gap-x-2 font-semibold text-gray-800'>
          <FaMapMarkerAlt className='text-primary-brand-color' />
          Teslimat Adresini Tamamla
        </div>
        <IoIosArrowForward className='text-primary-brand-color' />
      </div>
